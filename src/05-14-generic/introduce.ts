 ...
 */
function sumAll<T>(data: Array<number>) {
 ...
 */
const sumAllArrow = <T>(data: Array<number>) => data.reduce((prev, curr) => prev + curr, 0);
...
export { simple, sumAll, sumAllArrow, strConcatNum };
